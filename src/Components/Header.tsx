        ...
        <header>
            <div className="content-desktop">
                ...
                <div className="navbar">
                    ...
                    <Button color=" blue" onClick={() => redirectToLink('https://mantine.dev/')}>Contactez nous!</Button>
<Code color=" blue" style={{ display: 'flex', flexDirection: 'column', gap: 6, padding: 15 }}>
    Contacts
    <Anchor href="https://github.com">
        <UnstyledButton>
            <Group>
                <Avatar size={40} color="blue">logo</Avatar>
                <div>
                    <Text>Robert et fils</Text>
                    <Text size="xs" color="dimmed">robertetfils@gmail.com</Text>
                </div>
            </Group>
        </UnstyledButton>
    </Anchor>
